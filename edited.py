...
f = open(fname, 'a')
cwl = {'id':jsonf['name'],'cwlVersion':'v1.0', 'baseCommand':[], 'class': 'CommandLineTool',
...
def commandLine(item,cwlf):
    ...
    cwlf["arguments"] = [{"shellQuote": False, "valueFrom": """java -jar /gatk/GenomeAnalysisTK.jar -T HaplotypeCaller -R $(WDLCommandPart('NonNull(inputs.ref.path)', '')) 
